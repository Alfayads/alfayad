              ...
              <div className="lg:col-span-3 space-y-6 sm:space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    {/* Wholesale Billing Software Card */}
                    <div className="bg-black/50 border border-red-500/20 rounded-lg p-4 sm:p-6 hover:border-red-500/40 transition-all duration-300 group">
                      <div className="relative mb-4">
                        <div className="w-full h-32 sm:h-40 bg-gradient-to-br from-teal-600/20 to-teal-800/20 rounded-lg flex items-center justify-center relative overflow-hidden">
                          <div className="text-6xl sm:text-7xl">🧾</div>
                          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                        </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          <h3 className="font-bold text-white text-sm sm:text-base mb-1">WHOLESALE BILLING</h3>
                          <p className="text-red-400 text-xs font-semibold">DESKTOP BILLING SYSTEM</p>
                        </div>
                        
                        <p className="text-gray-300 text-xs sm:text-sm leading-relaxed">
                          Comprehensive desktop app for wholesale & retail billing with cloud sync and barcode support.
                        </p>
                        
                        <div className="flex flex-wrap gap-1 sm:gap-2">
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">Electron.js</span>
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">Supabase</span>
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">React</span>
                        </div>
                        
                        <div className="pt-2">
                          <a href="https://github.com/Alfayads/wholesale-billing-software" target="_blank" rel="noopener noreferrer" 
                             className="inline-flex items-center text-red-400 hover:text-red-300 text-xs font-semibold transition-colors">
                            View Code →
                          </a>
                        </div>
                    ...
                    {/* Qasar Al Haya Valet Card */}
                    <div className="bg-black/50 border border-red-500/20 rounded-lg p-4 sm:p-6 hover:border-red-500/40 transition-all duration-300 group">
                      <div className="relative mb-4">
                        <div className="w-full h-32 sm:h-40 bg-gradient-to-br from-emerald-600/20 to-emerald-800/20 rounded-lg flex items-center justify-center relative overflow-hidden">
                          <div className="text-6xl sm:text-7xl">🚗</div>
                          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                        </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          <h3 className="font-bold text-white text-sm sm:text-base mb-1">QH VALET PARKING</h3>
                          <p className="text-red-400 text-xs font-semibold">VALET PARKING BUSINESS</p>
                        </div>
                        
                        <p className="text-gray-300 text-xs sm:text-sm leading-relaxed">
                          Professional website for valet parking business with booking, real-time availability, and modern UI.
                        </p>
                        
                        <div className="flex flex-wrap gap-1 sm:gap-2">
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">Next.js</span>
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">Redux</span>
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">Tailwind</span>
                        </div>
                        
                        <div className="pt-2">
                          <a href="https://qhvalet.com/" target="_blank" rel="noopener noreferrer" 
                             className="inline-flex items-center text-red-400 hover:text-red-300 text-xs font-semibold transition-colors">
                            Visit Site →
                          </a>
                        </div>
                    ...
                    <div className="bg-black/50 border border-red-500/20 rounded-lg p-4 sm:p-6 hover:border-red-500/40 transition-all duration-300 group">
                      <div className="relative mb-4">
                        <div className="w-full h-32 sm:h-40 bg-gradient-to-br from-yellow-600/20 to-yellow-800/20 rounded-lg flex items-center justify-center relative overflow-hidden">
                          <div className="text-6xl sm:text-7xl">📦</div>
                          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                        </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          <h3 className="font-bold text-white text-sm sm:text-base mb-1">FD-POSTMAN-CLI</h3>
                          <p className="text-red-400 text-xs font-semibold">NPM PACKAGE - CLI TOOL</p>
                        </div>
                        
                        <p className="text-gray-300 text-xs sm:text-sm leading-relaxed">
                          Terminal-based Postman alternative for API testing. Install: npm i -g fd-postman-cli
                        </p>
                        
                        <div className="flex flex-wrap gap-1 sm:gap-2">
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">Node.js</span>
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">CLI</span>
                          <span className="bg-red-600/20 text-red-400 px-2 py-1 rounded text-xs">NPM</span>
                        </div>
                        
                        <div className="pt-2">
                          <a href="https://github.com/Alfayads/fd-postman-cli" target="_blank" rel="noopener noreferrer" 
                             className="inline-flex items-center text-red-400 hover:text-red-300 text-xs font-semibold transition-colors">
                            View Package →
                          </a>
                        </div>
